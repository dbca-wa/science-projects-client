...
const CaretakerModePage = () => {
	...
	const renderMyCaretakerSection = () => {
		...
		if (caretakerData?.caretaker_request_object) {
			const isMyRequest =
				caretakerData.caretaker_request_object.requester.id === currentUserId;
			...
			<section>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							These users have requested you to manage their projects while
							they're unavailable.
						</CardDescription>
					</CardHeader>
		...
		<div className="container mx-auto px-4 py-8 max-w-4xl">
			...
			<div className="mb-8">
				...
				<Alert>
					...
					<AlertDescription>
						Caretakers can manage your projects when you're unavailable (on
						leave, resignation, or other absence). All caretaker requests
						require admin approval for security and accountability.
					</AlertDescription>
				</Alert>
			</div>
