...
export const SREditor = ({ shouldAlternatePicture, fullSRData, initialConfig, isEditing, setIsEditing, canEdit,
    ...
    const saveMutation = useMutation(updateStudentReportProgress, {
        onMutate: () => {
            addToast({
                status: "loading",
