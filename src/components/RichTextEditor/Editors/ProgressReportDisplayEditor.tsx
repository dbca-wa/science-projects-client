...
export const ProgressReportDisplayEditor = ({
  project,
  pk,
  progress_report,
  report,
  ...
  useEffect(() => {
    if (progressData !== undefined && progressData !== null) {
      setProgressDisplayData(progressData);
    }
  }, []);

  const [progressDisplayData, setProgressDisplayData] = useState(progressData);

  useEffect(() => {
    // console.log("DISPLAY DATA:", displayData);
    setPrepopulationData(progressDisplayData);
  }, [progressDisplayData]);

  const [prepopulationData, setPrepopulationData] =
    useState(progressDisplayData);
