...
export const RichTextEditor = ({
    ...
    const generateTheme = (colorMode) => {
        return {
            ...
            tableAddColumns: colorMode === "light" ? 'table-add-columns-light' : 'table-add-columns-dark',
            tableAddRows: colorMode === "light" ? 'table-add-rows-light' : 'table-add-rows-dark',
            tableCell: colorMode === "light" ? 'table-cell-light' : 'table-cell-dark',
            tableCellActionButton: colorMode === "light" ? 'table-action-button-light' : 'table-action-button-dark',
            tableCellActionButtonContainer:
                colorMode === "light" ? 'table-action-button-container-light' : 'table-action-button-container-dark',
            tableCellEditing: colorMode === "light" ? 'table-cell-editing-light' : 'table-cell-editing-dark',
            tableCellHeader: colorMode === "light" ? 'table-cell-header-light' : 'table-cell-header-dark',
            tableCellPrimarySelected: colorMode === "light" ? 'table-cell-primary-selected-light' : 'table-cell-primary-selected-dark',
            tableCellResizer: colorMode === "light" ? 'table-cell-resizer-light' : 'table-cell-resizer-dark',
            tableCellSelected: colorMode === "light" ? 'table-cell-selected-light' : 'table-cell-selected-dark',
            tableCellSortedIndicator: colorMode === "light" ? 'table-cell-sorted-indicator-light' : 'table-cell-sorted-indicator-dark',
            tableResizeRuler: colorMode === "light" ? 'table-cell-resize-ruler-light' : 'table-cell-resize-ruler-dark',
            tableSelected: colorMode === "light" ? 'table-selected-light' : 'table-selected-dark',
            tableSelection: colorMode === "light" ? 'table-selection-light' : 'table-selection-dark',
