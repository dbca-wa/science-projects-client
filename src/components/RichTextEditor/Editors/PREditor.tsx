...
interface IPREditorProps {
    ...
    setManagementImplicationsDisplayData: React.Dispatch<React.SetStateAction<string>>;
...
export const PREditor = ({ shouldAlternatePicture, fullPRData,
    editableInitialConfig, uneditableInitialConfig,
    canEdit,
    isEditingContext, setIsEditingContext,
    isEditingAims, setIsEditingAims,
    isEditingProgress, setIsEditingProgress,
    isEditingImplications, setIsEditingImplications,
    isEditingFuture, setIsEditingFuture,
    aimsDisplayData, progressReportDisplayData, managementImplicationsDisplayData, futureDirectionsDisplayData, contextDisplayData,
    setAimsDisplayData, setProgressReportDisplayData, setManagementImplicationsDisplayData, setFutureDirectionsDisplayData, setContextDisplayData,
    // key 
}: IPREditorProps) => {
    ...
    const { register, handleSubmit, reset } = useForm<ISaveProgressReportSection>();
    ...
    const saveMutation = useMutation(updateProgressReportSection, {
        onMutate: () => {
            addToast({
                status: "loading",
    ...
    const [initialConfigFuture, setInitialConfigFuture] = useState<InitialConfigType>(uneditableInitialConfig);
    const [initialConfigImplications, setInitialConfigImplications] = useState<InitialConfigType>(uneditableInitialConfig);
    const [initialConfigProgress, setInitialConfigProgress] = useState<InitialConfigType>(uneditableInitialConfig);
    const [initialConfigAims, setInitialConfigAims] = useState<InitialConfigType>(uneditableInitialConfig);
    const [initialConfigContext, setInitialConfigContext] = useState<InitialConfigType>(uneditableInitialConfig);
    ...
    }, [initialConfigContext, isEditingContext, editableInitialConfig, uneditableInitialConfig])
    ...
    }, [initialConfigAims, isEditingAims, editableInitialConfig, uneditableInitialConfig])
    ...
    }, [initialConfigProgress, isEditingProgress, editableInitialConfig, uneditableInitialConfig])
    ...
    }, [initialConfigFuture, isEditingFuture, editableInitialConfig, uneditableInitialConfig])
    ...
    }, [initialConfigImplications, isEditingImplications, editableInitialConfig, uneditableInitialConfig])
                ...
                >
                    ...
                    <RichTextPlugin
                        ...
                        contentEditable={
                            ...
                            >
                                {/* Toolbar */}
                                {isEditingProgress === false ? null : <RevisedRichTextToolbar />}
                ...
                >
                    ...
                    <RichTextPlugin
                        ...
                        contentEditable={
                            ...
                            >
                                {/* Toolbar */}
                                {isEditingImplications === false ? null : <RevisedRichTextToolbar />}
