...
Props) => {
  const [displayText, setDisplayText] = useState<string>(
    selectedNodeType ? selectedNodeType : "Normal"
  );
  ...
  const clickedOnBulletText = () => {
    setDisplayText(shouldFurtherConcat || isSmall ? "Bullets" : "Bullet List");
  };

  const clickedOnNumberedText = () => {
    setDisplayText(shouldFurtherConcat || isSmall ? "Nums" : "Numbered List");
  };
