...
import {
    $getRoot, $getSelection, $isParagraphNode, $isRangeSelection, $isTextNode, COMMAND_PRIORITY_LOW, FORMAT_TEXT_COMMAND, LexicalEditor, SELECTION_CHANGE_COMMAND,
} from "lexical";
import { $isCodeHighlightNode } from '@lexical/code';

import { Box, useColorMode, Text, Button, Flex } from "@chakra-ui/react";
...
export default function FloatingToolbarPlugin({ anchorElem = document.body }
    : {
        anchorElem?: HTMLElement;
    }): JSX.Element | null {
