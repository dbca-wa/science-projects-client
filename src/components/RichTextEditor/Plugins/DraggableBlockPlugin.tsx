...
//     const top = mouseY - anchorElemRect.top - floatingElemRect.height / 2;
//     const left = mouseX - anchorElemRect.left - floatingElemRect.width / 2;
...
function useDraggableBlockMenu(
    ...
    useEffect(() => {
        if (menuRef.current) {
            setMenuPosition(draggableBlockElem, menuRef.current, anchorElem, toolbarHeight);
        }
    ...
    useEffect(() => {
        function onDragover(event: DragEvent): boolean {
            ...
            setTargetLine(targetLineElem, targetBlockElem, pageY, anchorElem, toolbarHeight);
...
export default function DraggableBlockPlugin({
    ...
    return useDraggableBlockMenu(editor, anchorElem, editor._editable, toolbarHeight);
}
