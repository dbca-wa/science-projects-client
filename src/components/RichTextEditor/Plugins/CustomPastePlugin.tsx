...
const handlePastedWordUnorderedList = (text: string, colorMode: string) => {
  ...
  // const levelThreeFinishedString = convertThirdLevel(text);
  // const levelOneFinishedString = convertFirstLevel(levelThreeFinishedString);

  return levelTwoFinishedString;
};
...
function $insertDataTransferForRichText(
  ...
  if (htmlString) {
    try {
      ...
      let levelOneFinishedString = handlePastedWordUnorderedList(
        withoutWhite,
        colorMode
      );
      ...
      //     const levelThrees = [];
      //     while (
      //       currentNode !== end.nextElementSibling &&
      //       currentNode !== null
      //     ) {
