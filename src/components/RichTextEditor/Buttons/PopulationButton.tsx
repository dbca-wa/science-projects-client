...
import { RTEPriorReportPopulationModal } from "@/components/Modals/RTEPriorReportPopulationModal";
...
export const PopulationButton = ({ canPopulate,
    // editorText,
    writeable_document_kind, section, project_pk }: Props) => {
