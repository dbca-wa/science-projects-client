...
export const Quote = () => {
    ...
    const { data: quote, isLoading: quotesLoading } = useQuery<IQuote>(["quote"], getQuote, {
    ...
    useEffect(() => {
        if (!quotesLoading) {
            ...
            authorControls.start({ opacity: 1, y: 0, transition: { delay: textArray.length * 0.025 + 0.5, duration: 1 } });
        }
