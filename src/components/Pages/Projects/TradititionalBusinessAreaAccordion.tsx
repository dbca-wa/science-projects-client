...
export const BusinessAreaAccordion = ({
  ...
  const {
    isOpen: isUpdateBusinessAreaModalOpen,
    onOpen: onOpenUpdateBusinessAreaModal,
    onClose: onCloseUpdateBusinessAreaModal,
  } = useDisclosure();
  ...
  return (
    <Accordion
      ...
      userSelect={"none"}
    >
      <UpdateBusinessAreaModal
        isOpen={isUpdateBusinessAreaModalOpen}
        onClose={onCloseUpdateBusinessAreaModal}
        businessAreaTitle={businessArea}
      />
      <AccordionItem
        rounded={"2xl"}
      ...
      >
        ...
        >
          <Box rounded="5px" overflow="hidden" my={4} pos="relative">
            <Box
              position="absolute"
              top={0}
              left={0}
            ...
            >
              ...
              >
                ...
                <Box justifyItems={"end"} justifySelf={"end"}>
                  <Button
                    color={"white"}
              ...
              >
                <Box
                  ...
                  justifySelf={"center"}
                />
                <Text>{businessAreaLeader}</Text>
                <Box as={AiFillTag} size="18px" mt={2} />
                <Text>{tags.join("; ")}</Text>
                <Box as={BsChatSquareFill} size="18px" mt={2} />
