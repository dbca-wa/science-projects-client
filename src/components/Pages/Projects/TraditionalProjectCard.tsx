...
import { Box, Button, Grid, Image, Tag, Text, useColorMode } from "@chakra-ui/react"
...
export const TraditionalProjectCard = ({ pk, projectTitle, imageUrl, years, authors, tags, statusTag, projectTypeTag }: IProjectCardProps) => {
