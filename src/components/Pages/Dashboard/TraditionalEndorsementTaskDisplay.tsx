...
import { Box, Button, Center, Flex, useColorMode, Text, Divider } from "@chakra-ui/react"
...
export const TraditionalEndorsementTaskDisplay = ({ endorsementKind, document }: IProps) => {
    ...
    return (
        ...
        /> */}
            ...
            >
                ...
                <Flex>
                    {/* <Text
                        color={`${endorsementKind === "directorate" ? "red" : endorsementKind === "business_area_lead" ? "orange" : "green"}.600`}
                        fontWeight={"semibold"}
                        fontSize={"small"}
                        mr={1}
                    >
                        {`${formattedKind(endorsementKind)}:`}
                    </Text> */}
                    <Text
                        color={"gray.500"}
                        fontWeight={"semibold"}
