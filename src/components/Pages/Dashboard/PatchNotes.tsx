        ...
        <Flex flexDir={"column"}>
          ...
          <List spacing={1} ml={2}>
            ...
            >
              ...
              Update: Batch populated Context and Aims sections for latest
              progress reports belonging to projects with prior reports
            </ListItem>
            <ListItem
              fontSize={"small"}
              textIndent={"-21px"}
            ...
            >
              <ListIcon as={MdCheckCircle} color="green.500" />
              Change: Rich text editors removed for auto-closed project closures
              (non-science project closures)
            </ListItem>
            <ListItem
              fontSize={"small"}
              textIndent={"-21px"}
            ...
            >
              <ListIcon as={MdCheckCircle} color="green.500" />
              Fix: Set status of project closures of non "science" to "approved"
              when auto closed
            </ListItem>
            <ListItem
              fontSize={"small"}
            ...
            >
              <ListIcon as={MdCheckCircle} color="green.500" />
              Fix: Prevented a project plan spawn bug caused by bad data when
              approving a concept plan that already has a project plan
            </ListItem>
            <ListItem
              fontSize={"small"}
              textIndent={"-21px"}
            ...
            >
              <ListIcon as={MdCheckCircle} color="green.500" />
              Fix: Fixed bug causing save button to gray out one word before
              word count limit
            </ListItem>
            ...
            >
              <ListIcon as={MdCheckCircle} color="green.500" />
              Feature: Added admin ability to batch populate progress reports
              for pre-existing progress reports (aims and context for latest
              year only)
            </ListItem>
          </List>
