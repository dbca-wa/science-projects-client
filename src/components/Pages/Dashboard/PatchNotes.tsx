...
export const PatchNotes = ({
	...
	const [spmsText, setSpmsText] = useState(
		...
		<>
            ...
            >
              ...
              could not see their tasks (x2)
						...
						>
							<ListIcon as={MdCheckCircle} color="green.500" />
							Fix: Fixed bug causing business area to not update
						...
						>
							<ListIcon as={MdCheckCircle} color="green.500" />
							Fix: Fixed bug causing business area leader tasks to
							not display in "My Tasks" section
						</ListItem>
						<ListItem
							fontSize={"small"}
							textIndent={"-21px"}
						...
						>
							<ListIcon as={MdCheckCircle} color="green.500" />
							Change: Extended the length for email fields from 30
							to 50 characters when creating an external user
						</ListItem>
						<ListItem
							fontSize={"small"}
							textIndent={"-21px"}
						...
						>
							<ListIcon as={MdCheckCircle} color="green.500" />
							Change: Added ability to optionally set external
							user's affiliation on creation
						</ListItem>
						<ListItem
							fontSize={"small"}
							textIndent={"-21px"}
						...
						>
							<ListIcon as={MdCheckCircle} color="green.500" />
							Change: Closed and Suspended project progress
							reports that exist for current FY will appear on
							Annual Report
						</ListItem>
						<ListItem
							fontSize={"small"}
						...
						>
							<ListIcon as={MdCheckCircle} color="green.500" />
							Feature: Added button for printing Annual Report
							with unapproved reports
						</ListItem>
						<ListItem
							fontSize={"small"}
							textIndent={"-21px"}
						...
						>
							<ListIcon as={MdCheckCircle} color="green.500" />
							Feature: Added ability for admins to add DBCA
							internal users (staff) without OIM data
						</ListItem>
						<ListItem
							fontSize={"small"}
							textIndent={"-21px"}
						...
						>
							<ListIcon as={MdCheckCircle} color="green.500" />
							Feature: Added "My Business Area" page for business
							area leaders to update text and image regarding
							their area.
						</ListItem>
					</List>
					...
					<span style={{ marginTop: 20 }}>
						<Text
							...
							fontWeight={"normal"}
						>
							We are always looking for ways to improve, and value
							your feedback! If you notice something off, or would
							like to request a change, please submit feedback
						...
						>
							{" "}
							Don't be shy, we can only make things better with
							your help!
						</Text>
					</span>
				</Flex>
