...
export const ModernEndorsementTaskDisplayCard = ({ document, kind }: IProps) => {
                    ...
                    >
                        <Flex>
                            ...
                            <Box>
                                <Text
                                    as={'span'}
                                    color={`${kind === "aec" ? "blue" : kind === "bm" ? "red" : "green"}.600`}
                                    fontWeight={"semibold"}
                                    fontSize={"small"}
                                    mr={1}
                                >
                                    {`${kind === "aec" ? "Animal Ethics Committee" : kind === "bm" ? "Biometrician" : "Herbarium Curator"}`}
                                </Text></Box>
