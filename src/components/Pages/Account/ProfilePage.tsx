...
import { Image, Box, Flex, Grid, Spinner, Text, useColorMode, useDisclosure, Center } from "@chakra-ui/react"
...
export const ProfilePage = () => {
    ...
    const {
        isOpen: isEditPersonalInformationModalOpen, onOpen: onOpenEditPersonalInformationModal,
        onClose: onCloseEditPersonalInformationModal } = useDisclosure();

    const {
        isOpen: isEditProfileModalOpen, onOpen: onOpenEditProfileModal,
        onClose: onCloseEditProfileModal } = useDisclosure();

    const {
        isOpen: isEditMembershipModalOpen, onOpen: onOpenEditMembershipModal,
        onClose: onCloseEditMembershipModal } = useDisclosure();
                    ...
                    <>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Text>{
                                        !me.is_staff ? "External" :
                                            me?.agency?.name ? me.agency.name : NoDataText
                                    }</Text>
                                </Flex>
                                {me.is_staff && (
                                    <>
                        ...
                        >
                            ...
                            <Grid
                                ...
                                alignItems="center"
                            >
                                <Text mb='8px' fontWeight={"bold"}>Admin?</Text>
                                {me?.is_superuser ? <FcApproval /> : <Box color={colorMode === "light" ? "red.500" : "red.600"}>
                                    <AiFillCloseCircle />
                                </Box>}
                            </Grid>
                        </Grid>
