					...
					<>
						<Flex>
							...
							>
								Project Role (
								{userRole
									? humanReadableRoleName(userRole)
									: "None"}
								)
							</Text>
						</Flex>
						<FormControl py={2}>
							...
							<FormHelperText>
								The role this team member fills within this
								project.
							</FormHelperText>
						</FormControl>
					</>
				...
				{!is_leader &&
					(me?.userData.is_superuser ||
						...
						<Button
							mt={4}
							bg={
								colorMode === "dark" ? "green.600" : "green.500"
							}
							color={"white"}
							_hover={{
								bg:
				...
				>
					<Flex flexDir={"column"}>
						...
						{!user?.is_staff && (
							...
							>
								<b>External User</b> - This user does not belong
								to DBCA
							</Text>
						)}
					</Flex>
