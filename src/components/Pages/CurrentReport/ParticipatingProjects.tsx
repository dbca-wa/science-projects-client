...
// import { SearchProjectsInReport } from "./SearchProjectsInReport";
...
export const ParticipatingProjects = ({ dateOpen, dateClosed }: IParticipatingProjectProps) => {
    const formatDate = (date: Date | null) => {
        if (date !== null) {
            const newDate = new Date(date).toLocaleDateString('en-GB', { day: "2-digit", month: "2-digit", year: "2-digit" });
            return newDate;
        }
        return '';
    };
