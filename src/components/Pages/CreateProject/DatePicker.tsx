...
export const DatePicker = ({ label, required, dateFormat, selectedDate, setSelectedDate, onChange, ...rest }: IDatePickerProps) => {
    ...
    const [selectedDay, setSelectedDay] = useState<Date | undefined>(selectedDate ? selectedDate : undefined);
    ...
    return (
        <Flex flexDir={'column'}>
            ...
            >
                <FormLabel>
                    ...
                    <Box
                        ...
                        alignItems={"center"}
                    >
                        <Icon as={BsFillCalendarEventFill} mr={2} />{label}
                    </Box>
                </FormLabel>
            </FormControl>
            ...
            <Box
                ...
                alignItems={"center"}
            >
                <Menu {...rest} placement="bottom-end"
                    isOpen={isOpen}
                    onClose={onClose}
                            ...
                            <Grid templateColumns='repeat(7, 1fr)' gap={3}>
                                {monthDetails.map((day, index) => {
                                    ...
                                    return isCurrentMonth ? (
                                        <Button
                                            color={
                                                isSelectedDay(day) ? "white" :
                                                    isCurrentDay(day) ? "white" :
                                            ...
                                            _hover={{
                                                ...
                                                backgroundColor: isSelectedDay(day) ? "blue.300" : "gray.100"
                                            }}
                                        >
                                            {day.date}
                                        </Button>
