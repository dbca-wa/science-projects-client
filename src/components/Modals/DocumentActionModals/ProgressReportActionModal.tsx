...
import { IApproveProgressReport, IBusinessArea, IProjectData } from "../../../types";
import { handleProgressReportAction } from "../../../lib/api";
...
export const ProgressReportActionModal = (
    { stage, documentPk, progressReportPk, onClose, isOpen, projectData, baData, action, refetchData }: Props
) => {
    ...
    const { register, handleSubmit, reset, watch } = useForm<IApproveProgressReport>();
    ...
    const approveProgressReportMutation = useMutation(handleProgressReportAction,
        {
            onMutate: () => {
                addToast({
                    status: "loading",
    ...
    const onApprove = (formData: IApproveProgressReport) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {!baData || !baLead || isDirectorateLoading || directorateData?.length < 1 ?
                        null : (
                            <>
                ...
                <ModalFooter>
                    ...
                    <Button
                        form="approval-form"
                        type="submit"
                        onClick={() => console.log(watchedProgressReportPk, watchedDocumentPk, watchedStage, watchedAction)}
