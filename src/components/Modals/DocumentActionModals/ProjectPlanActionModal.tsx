                    ...
                    {!baData || !baLead
                        ...
                        null : (
                            <>
                                ...
                                {/* <Input type="hidden" {...register("projectPlanPk", { required: true, value: projectPlanPk })} readOnly /> */}
                                {stage === 1 ?
                                    (
                                        <Box>
                                            <Text fontWeight={"bold"}>Stage 1</Text>
                                            <br />
                                            <Text>In your capacity as Project Lead, would you like to {action} this project plan?</Text>
                                            <br />
                                            <Text>
                                                {action === "approve" ?
                                    ...
                                    stage === 2 ?
                                        (
                                            <Box>
                                                ...
                                                <br />
                                                <Text>
                                                    In your capacity as Business Area Lead, would you like to {action} this project plan?
                                                </Text>
                                                <br />
                                                <Text>
                                                    {
