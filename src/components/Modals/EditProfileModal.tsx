...
export const EditProfileModal = ({ isOpen, onClose, userId }: IEditProfileModalProps) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <ModalOverlay />
            <ModalContent bg={colorMode === "light" ? "white" : "gray.800"} height="100%" display="flex" flexDirection="column" as={"form"} onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <Grid gridTemplateColumns={{ base: "3fr 10fr", md: "4fr 8fr" }} pos="relative" w="100%" h="100%">
                                    <Box>
                                        ...
                                        >
                                            <Image
                                                objectFit="cover"
                                                src={selectedImageUrl || noImageLink}
                                                alt="Preview"
                                                userSelect="none"
                                                bg="gray.800"
                                            />
