...
export const EditProjectModal = ({ projectPk, isOpen, onClose, refetchData }: Props) => {
            ...
            <Flex as={"form"}
                ...
                <ModalContent bg={colorMode === "light" ? "white" : "gray.800"}>
                    ...
                    <ModalBody>
                        ...
                        >
                            <UnorderedList>
                                <ListItem>Project team and area will be cleared</ListItem>
                                <ListItem>Any comments will be removed</ListItem>
                        ...
                        >
                            <Text>
                                If this is okay or this is a duplicate project, please proceed.
                            </Text>
                        </Center>
