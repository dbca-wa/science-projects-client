...
export const ChangeReportPDFModal = ({ isChangePDFOpen, onChangePDFClose, refetchPDFs, report }: Props) => {
            ...
            >
                ...
                <ModalFooter>
                    ...
                    <Button
                        ...
                        isDisabled={!uploadedPDF || !reportMediaId || reportMediaId === 0 || isError}
                        onClick={() => {
                            onSubmitPDFUpdate();
                        }}
                    >
