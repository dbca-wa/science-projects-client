                ...
                <ModalContent bg={colorMode === "light" ? "white" : "gray.800"}>
                    ...
                    <ModalBody>
                        ...
                        >
                            ...
                            {isExternalSP ? (
                                <Box my={4}>
                                    <Text color={"blue.500"}>A concept plan will NOT be created. </Text>
                                    <Text color={"blue.500"}>Instead a project plan will be created.</Text>
                                </Box>
                            ) : (
                                <Box my={4}>
                                    <Text color={"blue.500"}>A concept plan will be created.</Text>
