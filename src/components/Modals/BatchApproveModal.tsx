...
export const BatchApproveModal = ({
    isOpen,
    onClose,
}: IModalProps) => {
                    ...
                    <ModalBody>
                        <Center>
                            <Text fontWeight={"bold"} fontSize={"xl"}>
                                Are you sure you want to batch approve reports?
                            </Text>
                        </Center>
                        <Text mt={4}>
                            Any progress reports and student reports which meet these conditions, will get final approval:
                        </Text>
                        <Box mt={4}>
                            <UnorderedList>
                                <ListItem>
                                    Belongs to most recent annual report
                                </ListItem>
                                <ListItem>
                                    Belongs to an active project
                                </ListItem>
                                <ListItem>
                                    Is approved by Project Lead
                                </ListItem>
