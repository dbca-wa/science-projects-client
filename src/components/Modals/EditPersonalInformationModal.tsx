...
import { Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, useColorMode, Grid, FormControl, FormLabel, InputGroup, InputLeftElement, Input, Icon, Select, InputLeftAddon, useToast, FormErrorMessage, ToastId } from '@chakra-ui/react';
...
import { IPIUpdateVariables, IPIUpdateError, updatePersonalInformation, IPIUpdateSuccess, getPersonalInformation } from '../../lib/api';
...
export const EditPersonalInformationModal = ({ isOpen, onClose, userId }: IEditPIModalProps) => {

    const { isLoading, data } = useQuery<IPersonalInformation>(["personalInfo", userId], getPersonalInformation);
    ...
    const mutation = useMutation<
        IPIUpdateSuccess, IPIUpdateError, IPIUpdateVariables
    >(
