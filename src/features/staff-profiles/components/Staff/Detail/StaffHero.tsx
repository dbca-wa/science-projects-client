        ...
        <div className="flex flex-col">
          ...
          <div className="flex w-full flex-col justify-center p-4 pb-2 text-center">
            ...
            {staffHeroData?.it_asset_data && (
              <>
                <p className="mt-4 font-semibold text-balance text-slate-600 dark:text-slate-400">
                ...
                <p className="mt-2 text-sm font-medium text-balance text-slate-500 dark:text-slate-400">
          ...
          <div className="mt-4 flex">
            ...
            {staffHeroData?.user?.avatar && !isImageError && (
              <img
                ...
                alt={`Profile of ${staffHeroData?.name}`}
                className="pointer-events-none mr-4 size-[150px] shrink-0 rounded-lg object-cover select-none"
                onError={() => setIsImageError(true)}
              />
            )}
            ...
            <div className="flex w-full flex-col px-2">
              ...
              {staffHeroData?.it_asset_data && (
                <>
                  <p className="mt-2 font-semibold text-balance text-slate-600 dark:text-slate-400">
                  ...
                  <p className="mt-1 text-sm font-medium text-balance text-slate-500 dark:text-slate-400">
                    {staffHeroData?.it_asset_data?.location?.name
                      ? `${staffHeroData?.it_asset_data?.location?.name}`
                      : ""}
                  </p>
