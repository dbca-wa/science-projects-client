 ...
 */
export const OutgoingCaretakerRequest = ({
	request,
	onCancel,
}: OutgoingCaretakerRequestProps) => {
			...
			<AlertDialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Are you sure you want to cancel your request for {getUserName()}{" "}
				...
				>
					<AlertDialogContent>
						<AlertDialogHeader>
							...
							<AlertDialogDescription>
								Are you sure you want to approve this request? {getUserName()}{" "}
								will become your caretaker immediately.
