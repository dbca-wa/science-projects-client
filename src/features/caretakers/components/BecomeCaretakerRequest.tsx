...
import type { IBecomeCaretakerRequestProps } from "../types/caretaker.types";
 ...
 */
export const BecomeCaretakerRequest = ({
	request,
	onResponse,
			...
			<Card>
				...
				<CardContent className="space-y-4">
					...
					<Alert>
						...
						<AlertDescription>
							You can approve or reject this request directly. Approving will
							make you the caretaker for this user.
						</AlertDescription>
					</Alert>
			...
			<AlertDialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Are you sure you want to reject this caretaker request from{" "}
							{getUserName()}?
