 ...
 */
export const PendingCaretakerRequest = ({
	request,
	onCancel,
				...
				<CardContent className="space-y-4">
					...
					{request.notes && (
						<div>
							...
							<p className="text-sm bg-white dark:bg-gray-800 p-3 rounded-md">
								{request.notes}
							</p>
						</div>
					)}
							...
							{request.requester && (
								<>
									...
									<span className="font-medium">
										{request.requester.display_first_name}{" "}
										{request.requester.display_last_name}
									</span>
								</>
							)}
						</p>
					...
					{!isIncomingRequest && !isOutgoingRequest && (
						<Alert>
							<AlertCircle className="h-4 w-4" />
							<AlertDescription>
								This request is pending approval from the proposed caretaker or
								an administrator.
							</AlertDescription>
						</Alert>
					)}
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							{currentUser?.is_superuser && !isIncomingRequest ? (
								<>
									Are you sure you want to approve this caretaker request? This
									will establish the caretaker relationship immediately.
								...
								<>
									Are you sure you want to approve this caretaker request? You
									will become the caretaker for{" "}
									{userNeedingCaretaker.display_first_name}{" "}
									{userNeedingCaretaker.display_last_name} and be able to manage
									their projects.
								</>
							)}
						</AlertDialogDescription>
			...
			<AlertDialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Are you sure you want to reject this caretaker request? The
			...
			<AlertDialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Are you sure you want to cancel this caretaker request? This
