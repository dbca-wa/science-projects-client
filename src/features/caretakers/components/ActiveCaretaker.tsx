				...
				<CardContent className="space-y-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div>
							...
							<p className="text-sm">
								{getCaretakerReasonLabel(caretaker.reason)}
							</p>
						</div>
						...
						{caretaker.end_date && (
							<div>
								...
								<p
									className={`text-sm ${isExpired ? "text-red-600 font-medium" : ""}`}
								>
					...
					{isExpired && (
						<Alert variant="destructive">
							...
							<AlertDescription>
								This caretaker assignment has expired. Consider removing it or
			...
			<AlertDialog open={showRemoveDialog} onOpenChange={setShowRemoveDialog}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Are you sure you want to remove this caretaker? They will no
							longer be able to manage your projects.
							{!isExpired && (
