...
function DropdownMenu({
	...
	return (
		<DropdownMenuContext.Provider
			value={{ open: isVisible, onOpenChange, isClosing, shouldAnimate }}
		>
			{children}
		</DropdownMenuContext.Provider>
	);
