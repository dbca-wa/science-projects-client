    ...
    <div className="w-full">
      ...
      {staffOverviewLoading ? (
        ...
        <>
          ...
          >
            <div
              className={`pt-0 pb-4 ${staffOverviewData?.keyword_tags.length > 0 && "max-w-full border-gray-100"}`}
            >
...
const EditAboutDialog = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-3 mb-2">Edit About</DialogTitle>
          <DialogDescription
      ...
      >
        <div className="mx-auto w-full max-w-sm text-slate-800">
          <div className="no-scrollbar max-h-screen overflow-x-hidden overflow-y-scroll">
            <DrawerHeader>
              <DrawerTitle className="mt-3 mb-2">Edit About</DrawerTitle>
              <DrawerDescription
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-h-[80vh] w-[700px] max-w-[700px] overflow-y-auto text-slate-800">
        <DialogHeader>
          <DialogTitle className="mt-3 mb-2">Edit Expertise</DialogTitle>
        </DialogHeader>
        <EditStaffOverviewContent
    ...
    <Drawer open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DrawerContent className="w-full px-3 py-4">
        <div className="mx-auto w-full max-w-sm text-slate-800">
          <div className="no-scrollbar max-h-screen overflow-x-hidden overflow-y-scroll">
            <DrawerHeader>
              <DrawerTitle className="mt-3 mb-2">Edit Expertise</DrawerTitle>
            </DrawerHeader>
            <EditStaffOverviewContent
              sectionKind="expertise"
              staffOverviewData={staffOverviewData}
...
const EditKeywordsDialog = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-h-[80vh] w-[700px] max-w-[700px] overflow-y-auto text-slate-800">
        <DialogHeader>
          <DialogTitle className="mt-3 mb-2">Edit Keywords</DialogTitle>
        </DialogHeader>
        <EditStaffOverviewContent
    ...
    <Drawer open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DrawerContent className="p-3">
        <div className="mx-auto w-full max-w-sm text-slate-800">
          <div className="no-scrollbar max-h-screen overflow-x-hidden overflow-y-scroll">
            <DrawerHeader>
              <DrawerTitle className="mt-3 mb-2">Edit Keywords</DrawerTitle>
            </DrawerHeader>
            <EditStaffOverviewContent
              sectionKind="keyword_tags"
              staffOverviewData={staffOverviewData}
