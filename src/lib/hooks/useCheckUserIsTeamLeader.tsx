...
export const useCheckUserIsTeamLeader = (mePk: number | string | undefined, members: IProjectMember[]) => {
    ...
    useEffect(() => {
        ...
        const leaderInTeam = members.find(member => member.is_leader && member.user?.pk === mePk);
