...
export const sendReviewProjectDocumentEmail = async ({ recipients_list, project_pk, document_kind }: IReviewDocumentEmail) => {
    return instance.post(
        `documents/review_document_email`, {
...
export const sendNewReportingCycleOpenEmail = async ({ financial_year, include_projects_with_status_updating }) => {
    return instance.post(
        `documents/new_cycle_email`, {
        "financial_year": financial_year,
        "include_projects_with_status_updating": include_projects_with_status_updating,
    }
    ).then(res => {
        return res.data;
    }
...
export const sendProjectClosureEmail = async ({ project_pk }: IProjectClosureEmail) => {
    return instance.post(
        `documents/project_closure_email`, {
        "project_pk": project_pk,
    }
    ).then(res => {
        return res.data;
...
export const sendDocumentReadyEmail = async ({ recipients_list, project_pk, document_kind }: IDocumentReadyEmail) => {
    return instance.post(
        `documents/document_ready_email`,
        {
            "recipients_list": recipients_list,
            "project_pk": project_pk,
            "document_kind": document_kind,
...
export const sendDocumentSentBackEmail = async ({ recipients_list, project_pk, document_kind, stage }: IDocumentSentBack) => {
    return instance.post(
