...
const baseBackendUrl = process.env.NODE_ENV === "development" ? "http://127.0.0.1:8000/api/v1/" : "https://cycle-test-clusterip.cycle:8000/api/v1";
// Prod - points to the clusterip in cycle kubernetes namespace (instead of "https://cycle-test-clusterip.cycle:8000/api/v1" "https://scienceprojects-test-api.dbca.wa.gov.au/api/v1" "http://scienceprojects-test-api.dbca.wa.gov.au/api/v1")
