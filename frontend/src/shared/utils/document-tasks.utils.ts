// Document task utilities shared between dashboard and caretakers features
...
import {
	...
	type ProjectKind,
	type TaskLevel,
} from "@/shared/constants/document-tasks.constants";
 ...
 * Prioritises lead tasks — if a document appears in both arrays, only the lead version is included
