 ...
 */
export const NavigationButton = forwardRef<HTMLAnchorElement, NavigationButtonProps>(
  ({ targetPath, onClick: onStandardNavigation, children, className, variant, size, ...props }, ref) => {
    ...
    return (
      <a
        ...
        href={targetPath}
        onClick={handleClick}
        className={cn("no-underline cursor-pointer", buttonVariants({ variant, size, className }))}
        {...props}
      >
        {children}
      </a>
