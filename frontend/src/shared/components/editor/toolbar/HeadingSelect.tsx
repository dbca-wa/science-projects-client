...
export const HeadingSelect: React.FC<HeadingSelectProps> = ({ disabled = false, disableHeadings = false }) => {
  ...
  return (
    ...
    >
      ...
      <SelectContent>
        ...
        <SelectItem value="h1" disabled={disableHeadings}>{blockTypeLabels.h1}</SelectItem>
        <SelectItem value="h2" disabled={disableHeadings}>{blockTypeLabels.h2}</SelectItem>
        <SelectItem value="h3" disabled={disableHeadings}>{blockTypeLabels.h3}</SelectItem>
      </SelectContent>
    </Select>
  );
};
