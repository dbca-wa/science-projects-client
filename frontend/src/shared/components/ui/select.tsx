...
/**
 * Select component — wraps Radix Select.
 *
 * Close animations are intentionally removed to prevent flicker caused
 * by MobX observer re-renders destroying the portal mid-animation.
 * Open animations are preserved for a smooth appearance.
 */
function Select({
	...props
