		...
		<div className="mt-3 flex justify-center bg-[#2d2f32] px-8 py-4 text-white dark:bg-slate-950">
			...
			<div className="flex flex-col text-center">
				<p className="text-balance pb-2 text-sm text-slate-300">
					© Government of Western Australia {currentYear}. All rights
					reserved.
				</p>
				<div className="flex justify-between">
					<Button
						...
						onClick={() =>
							window.open(
								"https://www.dbca.wa.gov.au/contact",
								"_blank"
							)
						}
					...
					<Button
						...
						onClick={() =>
							window.open(
								"https://www.dbca.wa.gov.au/copyright",
								"_blank"
							)
						}
						className="bg-transparent text-sm text-slate-200"
					...
					<Button
						...
						onClick={() =>
							window.open(
								"https://www.dbca.wa.gov.au/privacy",
								"_blank"
							)
						}
						className="bg-transparent text-sm text-slate-200"
