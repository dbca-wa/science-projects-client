...
import type { ICaretakeesTableProps, ICaretakee } from "../types/caretaker.types";
...
export const CaretakeesTable = ({ caretakees }: ICaretakeesTableProps) => {
  ...
  const [caretakeeToRemove, setCaretakeeToRemove] = useState<ICaretakee | null>(null);
              ...
              <table className="w-full caption-bottom text-sm">
                <thead className="[&_tr]:border-b">
                  <tr className="hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-colors">
                    <th className="text-foreground h-10 px-2 text-left align-middle font-medium whitespace-nowrap">User</th>
                    <th className="text-foreground h-10 px-2 text-left align-middle font-medium whitespace-nowrap">End Date</th>
