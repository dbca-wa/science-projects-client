			...
			<>
				...
				{!displayTask && !isLoading && !error && open && (
					<div className="p-6">
						<Alert variant="destructive">
							<AlertCircle className="size-4" />
							<AlertDescription>Caretaker request not found</AlertDescription>
						</Alert>
					</div>
				)}
										...
										<div className="flex items-center gap-3">
											...
											<div className="flex-1 min-w-0">
												<p className="font-semibold text-green-600 dark:text-green-400 truncate">
													{primaryUser.display_first_name}{" "}
													{primaryUser.display_last_name}
												</p>
								...
								<div className="border border-gray-300 dark:border-gray-500 rounded-xl p-4">
									...
									{caretaker ? (
										...
										<div className="text-center py-4 text-muted-foreground">
											<Users className="mx-auto h-8 w-8 mb-2 opacity-50" />
											<p className="text-sm">
												Caretaker information not available
											</p>
										</div>
									)}
								</div>
								...
								<div className="space-y-3">
									...
									{requester && (
										<div>
											...
											<p className="text-sm text-gray-900 dark:text-gray-100 mt-1">
												{requester.display_first_name}{" "}
												{requester.display_last_name}
											</p>
