				...
				<div className="hidden md:block">
					...
					>
						<div className="flex items-center space-x-2">
							...
							<Label
								htmlFor="caretaker-tasks-filter-all"
						...
						<div className="flex items-center space-x-2">
							...
							<Label
								htmlFor="caretaker-tasks-filter-team"
								className="cursor-pointer font-normal"
							>
								Team Tasks
							</Label>
						...
						<div className="flex items-center space-x-2">
							...
							<Label
								htmlFor="caretaker-tasks-filter-lead"
								className="cursor-pointer font-normal"
							>
								Lead Tasks
							</Label>
						...
						<div className="flex items-center space-x-2">
							...
							<Label
								htmlFor="caretaker-tasks-filter-ba"
								className="cursor-pointer font-normal"
							>
								BA Tasks
							</Label>
						...
						<div className="flex items-center space-x-2">
							<RadioGroupItem
								value="directorate"
								id="caretaker-tasks-filter-directorate"
							/>
							<Label
								htmlFor="caretaker-tasks-filter-directorate"
								className="cursor-pointer font-normal"
							>
								Directorate Tasks
							</Label>
