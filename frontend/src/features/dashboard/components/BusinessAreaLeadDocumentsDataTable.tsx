/**
 * BusinessAreaLeadDocumentsDataTable Component
 * 
 * Displays business area lead document tasks using the generic DataTable.
 */
...
// Orange theme for business area lead tasks
const baLeadTheme = {
...
export const BusinessAreaLeadDocumentsDataTable = ({
	...
	return (
		<DataTable
			...
			ariaLabel="Business area lead document tasks"
			theme={baLeadTheme}
		/>
	);
};
