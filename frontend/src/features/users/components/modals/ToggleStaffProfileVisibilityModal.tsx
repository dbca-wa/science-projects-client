    ...
    const toggleMutation = useMutation({
      ...
      onError: (error: any) => {
        const message =
          ...
          "Failed to toggle staff profile visibility";
        toast.error(message);
      },
    });
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              {isHidden ? (
                <p>
                  Showing your staff profile will make it visible on the public
                  staff directory and accessible via direct link.
                </p>
              ) : (
                <p>
                  Hiding your staff profile will remove it from the public staff
                  directory. It will no longer be accessible to external users.
                </p>
              )}
            </div>
          </div>
