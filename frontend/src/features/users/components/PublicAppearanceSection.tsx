 ...
 */
export const PublicAppearanceSection = ({ user, onClick }: PublicAppearanceSectionProps) => {
    ...
    >
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-muted-foreground">
              {isVisible ? (
                <>Your profile is <span className="font-medium text-foreground">visible</span> on the public staff directory</>
              ) : (
                <>Your profile is <span className="font-medium text-foreground">hidden</span> from the public staff directory</>
              )}
            </p>
          </div>
        </div>
        ...
        <div className="text-sm text-muted-foreground">
          {isVisible ? (
            <p>
              Your profile appears in the public staff directory. Other users can view your contact information and expertise.
            </p>
          ) : (
            <p>
              Your profile is hidden from the public staff directory. Only administrators can view your full profile.
            </p>
          )}
        </div>
      </CardContent>
