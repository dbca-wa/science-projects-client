...
export const StatefulMediaChangerAvatar = observer(
	({
		selectedImageUrl,
		setSelectedImageUrl,
		selectedFile,
					...
					{hasValidImage && (
						<div className="flex flex-col gap-4 justify-center min-w-[200px]">
							...
							<div>
								...
								<div
									className={cn(
										"w-[150px] h-[150px] rounded-lg overflow-hidden border",
										uiStore.theme === "light"
											? "border-gray-200"
											: "border-gray-600"
									)}
...
StatefulMediaChangerAvatar.displayName = "StatefulMediaChangerAvatar";
