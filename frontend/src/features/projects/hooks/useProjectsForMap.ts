...
import { getProjectsForMap, type ProjectMapSearchParams } from "../services/project.service";
...
export const projectMapKeys = {
	...
	list: (params: ProjectMapSearchParams) => [...projectMapKeys.all, params] as const,
};
