import type { ProjectStatus, ProjectKind, IProjectData } from "@/shared/types/project.types";
 ...
 */
export const getProjectStatusDisplay = (status: ProjectStatus | string | null | undefined): string => {
	if (!status) return "";
 ...
 */
export const getProjectKindDisplay = (kind: ProjectKind | string | null | undefined): string => {
	if (!kind) return "";
 ...
 */
export const getProjectYearDisplay = (project: IProjectData | null | undefined): string => {
	if (!project) return "";
 ...
 */
export const parseProjectKeywords = (keywords: string | null | undefined): string[] => {
	if (!keywords) return [];
 ...
 */
export const formatProjectNumber = (year: number | null | undefined, number: number | null | undefined): string => {
 ...
 */
export const getProjectTag = (project: IProjectData | null | undefined): string => {
	if (!project) return "";
 ...
 */
export const getProjectStatusColor = (status: ProjectStatus | string | null | undefined): string => {
 ...
 */
export const getProjectKindColor = (kind: ProjectKind | string | null | undefined): string => {
	if (!kind) return "gray";
