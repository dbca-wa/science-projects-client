import type { IProjectData, IExtendedProjectDetails, IProjectMember } from "@/shared/types/project.types";
	...
	return (
		<div className="space-y-6">
			...
			<div className="rounded-lg border bg-card p-6">
				...
				<div className="mt-4">
					<p className="text-sm font-semibold text-muted-foreground">Business Area</p>
