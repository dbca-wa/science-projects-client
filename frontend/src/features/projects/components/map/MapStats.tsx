...
export const MapStats = observer(
	({ projectCount, totalProjects, projectsWithoutLocation }: MapStatsProps) => {
		return (
			<div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm text-muted-foreground backdrop-blur-sm bg-white/95 dark:bg-gray-800/95 max-w-[calc(100vw-8rem)]">
