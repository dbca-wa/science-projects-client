...
describe("CreateProgressReportModal", () => {
	...
	describe("Rendering", () => {
		...
		it("should display modal description", () => {
			...
			expect(
				screen.getByText(/select the year for the new progress report/i)
			).toBeInTheDocument();
		});
	...
	describe("Initial State", () => {
		it("should have no year selected initially", () => {
			...
			expect(yearSelect).toHaveTextContent(/select a year/i);
		});
	...
	describe("Year Selection", () => {
		...
		it("should show existing years info when provided", () => {
			renderModal(true);

			expect(
				screen.getByText(/existing reports: 2023, 2022/i)
			).toBeInTheDocument();
		});

		it("should not show existing years info when none provided", () => {
			renderModal(true);

			expect(screen.queryByText(/existing reports/i)).not.toBeInTheDocument();
		});
	});
