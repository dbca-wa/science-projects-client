    ...
    <div className="container max-w-4xl py-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update your profile image, about section, and expertise. This information will be visible to other users within the system.
            {user.is_staff && (
              <>
                {" "}It will also appear on your public staff profile when visibility is enabled.
              </>
            )}
          </CardDescription>
        </CardHeader>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-blue-700 dark:text-blue-200 mt-1">
                        This profile information will appear on the public staff directory when your profile visibility is enabled. 
                        You can control your public profile visibility in the "Public Profile" tab.
                      </p>
                    </div>
                  </div>
                </div>
