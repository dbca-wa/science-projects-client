...
export class ProjectMapStore extends BaseStore<ProjectMapState> {
	...
	get filterCount(): number {
		...
		if (this.state.filters.selectedBusinessAreas.length > 0) count += this.state.filters.selectedBusinessAreas.length;
	...
	get searchParams(): URLSearchParams {
		...
		if (this.state.filters.selectedBusinessAreas.length > 0) {
			params.set('businessAreas', this.state.filters.selectedBusinessAreas.join(','));
		}
	...
	get apiParams(): ProjectMapSearchParams {
		return {
			...
			businessAreas: this.state.filters.selectedBusinessAreas.length > 0 ? this.state.filters.selectedBusinessAreas : undefined,
