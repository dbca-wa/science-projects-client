...
const MergeUsersPage = lazy(() => import("@/pages/manage/MergeUsersPage"));
...
export const ADMIN_ROUTES: RouteConfig[] = [
	...
	{
		name: "Data Lists - Unapproved",
		path: "/manage/data/unapproved",
		component: DataListsPage,
		requiresAuth: true,
		requiresAdmin: true,
		showInSidebar: false,
	...
	{
		name: "Data Lists - Problematic",
		path: "/manage/data/problematic",
		component: DataListsPage,
		requiresAuth: true,
		requiresAdmin: true,
		showInSidebar: false,
