...
3. Check that both prod and test kustomisation files are updated
4. Merge the PR
...
2. Manual changes to kustomisation files
3. Partial PR merge
...
- Manually edit kustomisation files (use automation)
...
- **Kubernetes Overview**: `kubernetes-overview.md` - Kubernetes configuration and deployment
